...
class MarvellousLogin extends Template implements ActionListener, Runnable
{
    ...
    public MarvellousLogin()
    {
        ...
        TopLabel.setBounds(50,40,topsize.width+10, topsize.height);
        _header.add(TopLabel);

        label1 = new JLabel();
        label1.setText("Username:");
        label1.setForeground(Color.white);
        Dimension s1ize = label1.getPreferredSize();

        label1.setBounds(50,135,s1ize.width+3,s1ize.height);
        ...
        label2.setBounds(50,175,size.width+3,size.height);
        ...
        SUBMIT.setBounds(50,220,ssize.width+3,ssize.height);
